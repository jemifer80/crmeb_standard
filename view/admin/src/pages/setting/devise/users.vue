        ...
        <Card :bordered="false" dis-hover>
            <div class="acea-row row-top">
                <div class="left" :style="colorStyle">
                    ...
                    <div class="newcomersCon dotted" :class="{solid:current==5}"  v-if="userData.newcomer_status==1" @click="currentShow(5)">
                        <div v-if="newList.length" class="newcomers" :class="{on:userData.newcomer_style===2}">
                        ...
                        <div class="default" v-else>暂无新人专享数据</div>
                    </div>
            ...
            getInfo(){
                ...
                let picList = [
                    ...
                    require('@/assets/images/orange-bg.png'),
					          require('@/assets/images/gold-bg.png')
                ];
                getMember().then(res=>{
