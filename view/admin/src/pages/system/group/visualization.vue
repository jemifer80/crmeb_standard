					...
					<div class="iframe-boxs">
						<div class="moneyBox">
							...
							<div class="moneyBox_content">
								...
								<div class="box3">
										<div v-if="item.status != 0" class="box3_box" v-for="(item,index) in sginList.list" :key="index+'price'">
        ...
        <!-- 自定义配置页面展示 -->
				   ...
				   <img src="../../../assets/images/pclogin.png" class="pciframe-box"></img>
					<div class="pcmoddile_goods">
						...
						<swiper v-else :options="swiperOption" class="pcswiperimg_goods">
						    <swiper-slide class="spcwiperimg_goods" v-for="(item,index) in tabList.list" :key="index+'img'">
								<img :src="item.slide" >
							</swiper-slide>
						</swiper>
					</div>
				...
				<Col v-if="name == 'integral_shop_banner'" class="iframe" :bordered="false">
					<div class="iframe-box">
						...
						<div class="moddile_goods">
							...
							<swiper v-else :options="swiperOption" class="pcswiperimg_goods">
							    <swiper-slide class="swiperimg_goods" v-for="(item,index) in tabList.list" :key="index+'banner'">
									<img :src="item.img" >
								</swiper-slide>
							</swiper>
						</div>
				...
				<Col v-if="name == 'sign_day_num'" class="iframe" :bordered="false">
					<div class="iframe-box">
						...
						<img v-if="bgimg == 6" src="../../../assets/images/goldsgin.png">
					</div>
				</Col>
