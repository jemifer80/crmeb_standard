<template>
  <div>
    <div class="main">
      ...
      <Card :bordered="false" dis-hover class="mr20 card-tree">
        <div class="tree">
          <div class="main-btn">
      ...
      <Card :bordered="false" dis-hover class="right-card">
        <div class="data">
          <div class="eidt-sub">
            <div class="name">
              {{ formValidate.name }}
              ...
              <Col span="24">
                ...
                <FormItem label="请求参数：">
                  ...
                  >
                    ...
                    <vxe-column field="attribute" min-width="200" title="属性" tree-node :edit-render="{}">
                      <template #default="{ row }">
                        <vxe-input v-if="isEdit" v-model="row.attribute" type="text"></vxe-input>
                        <span v-else>{{ row.attribute || '' }}</span>
                      </template>
                    </vxe-column>
                    <vxe-column field="type" title="类型" min-width="200" :edit-render="{}">
                      <template #default="{ row }">
                    ...
                    <vxe-column field="must" title="必填" min-width="150" :edit-render="{}">
                      <template #default="{ row }">
                        <vxe-checkbox
                            v-if="isEdit"
                            v-model="row.must"
                    ...
                    <vxe-column field="trip" title="说明" min-width="200" :edit-render="{}">
                      <template #default="{ row }">
                ...
                <FormItem label="返回参数：">
                  ...
                  >
                    <!-- <vxe-column type="checkbox" width="60"></vxe-column> -->
                    <vxe-column field="attribute" title="属性" min-width="200" tree-node :edit-render="{}">
                      <template #default="{ row }">
                        <vxe-input v-if="isEdit" v-model="row.attribute" type="text"></vxe-input>
                        <span v-else>{{ row.attribute || '' }}</span>
                      </template>
            ...
            <Row :gutter="24" type="flex">
              <Col span="24">
                ...
                <FormItem label="错误码：">
                  ...
                  >
                    <!-- <vxe-column type="checkbox" width="60"></vxe-column> -->
                    <vxe-column field="code" title="错误码" min-width="200" tree-node :edit-render="{}">
                      <template #default="{ row }">
                        <vxe-input v-if="isEdit" v-model="row.code" type="text"></vxe-input>
                        <span v-else>{{ row.code || '' }}</span>
                      </template>
                    </vxe-column>
                    <vxe-column field="value" title="错误码取值" min-width="200" :edit-render="{}">
                      <template #default="{ row }">
                        <vxe-input v-if="isEdit" v-model="row.value" type="text"></vxe-input>
                        <span v-else>{{ row.value || '' }}</span>
                      </template>
                    </vxe-column>
                    <vxe-column field="solution" title="解决方案" min-width="200" :edit-render="{}">
                      <template #default="{ row }">
...
/deep/.vxe-table--empty-content{font-size: 12px;}
...
/deep/.vxe-body--row~.vxe-body--row .vxe-body--column{
