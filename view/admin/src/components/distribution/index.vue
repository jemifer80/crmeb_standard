    ...
    <div class="putSupplier" v-for="(item,index) in newArrayData" :key="index">
      <div class="header acea-row row-between-wrapper">
        <div class="left acea-row row-middle">
          ...
          <div class="info">
            <div><span class="name">商户名称：</span><span>{{item.merchant_name}}</span></div>
            <!--
      ...
      <div class="mt20">
        <Table border :columns="columns" :data="item.goodsList" :disabled-hover="true"  class="table-container">
...
background-color: #fff;
  ...
  .table-container::v-deep .ivu-table-cell{
