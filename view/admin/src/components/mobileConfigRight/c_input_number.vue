<template>
    <div class="numbox" v-if="configData">
        <div class="c_row-item" :class="configData.mtop?'on':''">
        ...
        <Col span="19" class="slider-box">
            ...
            <InputNumber v-model="configData.val" :placeholder="configData.placeholder?configData.placeholder:'请输入数量'" :step="1" :max="100" :min="1" @on-change="bindChange" style="text-align: right;"></InputNumber>
        </Col>
        </div>
    </div>
</template>
