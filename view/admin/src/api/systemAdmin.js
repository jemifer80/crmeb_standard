 ...
 * @param {Object} param data {Object} 传值参数
 */
export function adminSalesmanListApi(data) {
    return request({
      url: '/setting/salesman',
      method: 'get',
      params: data,
    });
};
   ...
   * @description 业务员添加表单
   */
  export function adminSalesmanFromApi() {
    return request({
      url: '/setting/create_salesman',
      method: 'get',
    });
};
   ...
   * @param {Number} param id {Number} 管理员id
   */
  export function adminSalesmanEditFromApi(id) {
    return request({
      url: `/setting/admin/${id}/edit_salesman`,
      method: 'get',
    });
};