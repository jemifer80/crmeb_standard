		...
		<!-- #endif -->
			<view class='navbarH' :style='"height:"+navH+"rpx;"'>
				<view class='navbarCon acea-row row-center-wrapper'>
					<view class="header acea-row row-center-wrapper" :style="{flex: 1, margin: `0 ${headerRight}px 0 ${headerLeft}px`}">
	...
	export default {
		...
		onReady(){
			...
			query.select('#home').boundingClientRect(data => {
			  this.headerRight = systemInfo.windowWidth - menuButtonInfo.right + menuButtonInfo.width;
			  this.headerLeft = data.left + data.width;
			}).exec();
			// #endif
		},
		onShow(){
