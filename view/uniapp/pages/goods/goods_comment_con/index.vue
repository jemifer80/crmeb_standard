		...
		<form @submit="formSubmit" report-submit='true'>
			<view class='evaluate-con'>
				<view class='goodsStyle acea-row row-between'>
					<view class='pictrue'>
						<image :src='productInfo.attrInfo?productInfo.attrInfo.image:productInfo.image'></image>
					</view>
					<view class='text acea-row row-between'>
						<view class='name line3'>{{productInfo.store_name}}</view>
						<view class='money'>
							<view>￥{{productInfo.attrInfo?productInfo.attrInfo.price:productInfo.price}}</view>
