	...
	<view :style="colorStyle">
		<view class='order-details'>
			...
			<view class='wrapper'>
				...
				<view class='item acea-row row-between' v-if="cartInfo.total_integral>0">
					<view>支付积分：</view>
					<view class='conter'>{{cartInfo.total_integral}}</view>
				</view>
				<view class='item acea-row row-between' v-if="cartInfo.total_price>0">
					<view>支付金额：</view>
