 ...
 * 活动边框
 * Class ActivityFrame
 * @package app\controller\admin\v1\marketing\activityFrame
 */
class ActivityFrame extends AuthController
{

    /**
     * ActivityFrame constructor.
     * @param App $app
     * @param ActivityFrameServices $services
     */
    public function __construct(App $app, ActivityFrameServices $services)
    {
