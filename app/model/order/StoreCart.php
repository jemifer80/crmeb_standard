...
class StoreCart extends BaseModel
{
     ...
     * @return \think\model\relation\HasOne
     */
    public function storeBranchProductAttr()
    {
        return $this->hasOne(StoreBranchProductAttrValue::class, 'unique', 'product_attr_unique');
    }
     ...
     * @param $value
     */
    public function searchCartIdsAttr($query, $value)
    {
        if ($value) {
            if (is_array($value)) {
     ...
     * @param $value
     */
    public function searchTouristUidAttr($query, $value)
    {
        if ($value) {
            $query->where('tourist_uid', $value);
        }
    }
     ...
     * @param $data
     */
    public function searchProductTypeAttr($query, $value, $data)
    {
        if (is_array($value)) {
